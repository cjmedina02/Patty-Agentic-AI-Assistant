...
log = logging.getLogger("patty_alu")
load_dotenv()

SYSTEM_PROMPT = """
You are the Code Analysis Agent, functioning as the Arithmetic Logic Unit (ALU) of the Patty multi-agent architecture.
...
def initialize_patty() -> StateGraph:
    ...
    graph_builder.add_edge("file_stats_tool", "patty")
